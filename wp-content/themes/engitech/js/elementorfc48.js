    ...
    var testimonialSlider5 = function ( $scope , $ ) {
        $scope.find('.ot-testimonials-slider').each( function () {
            ...
            $selector.not( '.slick-initialized' ).slick({
                ...
                prevArrow: '<button type="button" class="prev-nav flex-middle"><svg width="18" height="20" viewBox="0 0 18 20" xmlns="https://www.w3.org/2000/svg"><path d="M0.666671 10.1332L17.6667 0.318263L17.6667 19.9482L0.666671 10.1332Z" fill="url(#paint0_linear_74_30)"/><defs><linearGradient id="paint0_linear_74_30" x1="4.01887" y1="6.86588" x2="19.228" y2="17.5427" gradientUnits="userSpaceOnUse"><stop stop-color="#0FD2ED"/><stop offset="1" stop-color="#008DF3"/></linearGradient></defs></svg></button>',
                nextArrow: '<button type="button" class="next-nav flex-middle"><svg width="18" height="20" viewBox="0 0 18 20" xmlns="https://www.w3.org/2000/svg"><path d="M0.666671 10.1332L17.6667 0.318263L17.6667 19.9482L0.666671 10.1332Z" fill="url(#paint0_linear_74_30)"/><defs><linearGradient id="paint0_linear_74_30" x1="4.01887" y1="6.86588" x2="19.228" y2="17.5427" gradientUnits="userSpaceOnUse"><stop stop-color="#0FD2ED"/><stop offset="1" stop-color="#008DF3"/></linearGradient></defs></svg></button>',
                responsive: [
                    {
                        breakpoint: 1199,
                        settings: {
