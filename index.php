...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["inputEmail"])) {
    ...
    // Require PHPMailer files only when needed
    require 'PHPMailer/src/Exception.php';
    require 'PHPMailer/src/PHPMailer.php';
    require 'PHPMailer/src/SMTP.php';

    // Use !empty() for a more robust check
    if (!empty($_POST["inputEmail"]) && !empty($_POST["firstName"]) && !empty($_POST["lastName"]) && !empty($_POST["phone"]) && !empty($_POST["msgTextarea"])) {
        ...
        if(!$mail->send()) {
            ...
            // The following line doesn't do anything. You might want to log the error.
                                                ...
                                                <div class="projects-thumbnail">
                                                    <a href="projects/rightview-service-station">
                                                        <img
                                                            ...
                                                            width="720"
                                                            height="520"
                                                            src="data:image/svg+xml,%3Csvg%20xmlns='https://www.w3.org/2000/svg'%20viewBox='0%200%20720%20520'%3E%3C/svg%3E"
